  ...
  return (
    <div style={{ display:'flex', flexDirection:'column', gap:'12px' }}>
      ...
      <div style={{ display:'flex', gap:'8px', flexWrap:'wrap' }}>
        ...
        >
          <span>📄</span> {t('context.fileButton')}
        </button>
        ...
        >
          <span>📝</span> {t('context.noteButton')}
        </button>
      </div>
      ...
      {items.length === 0 && !urlOpen && !noteOpen && (
        ...
        >
          <p style={{ fontSize:'13px', color:'var(--t3)', lineHeight:1.6 }}>
            ...
            <span style={{ fontSize:'11px' }}>{t('context.dropSubHint')}</span>
          </p>
        </div>
      )}
      ...
      {urlOpen && (
        <div style={{ display:'flex', gap:'8px' }} className="fade-in">
          <input
            ...
            placeholder={t('context.urlPlaceholder')}

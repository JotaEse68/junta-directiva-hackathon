...
const DICT = {
  en: {
    ...
    'board.subtitle': 'Great decisions are challenged, contrasted, and made explicit. Bring yours to 12 specialized directors and leave with a clear direction.',
    ...
    'overview.kicker': 'More than an opinion',
    'overview.title': 'A deliberation you can follow.',
    'overview.stepOne': 'Debate',
    'overview.stepOneDesc': 'Specialists examine your decision, one perspective at a time.',
    'overview.stepTwo': 'Direction',
    'overview.stepTwoDesc': 'The Chairman turns the debate into a verdict and next steps.',
    'overview.stepThree': 'Challenge & refine',
    'overview.stepThreeDesc': 'Question the verdict, add a PDF, Markdown or image, and redirect the decision with the Chairman.',
  ...
  es: {
    ...
    'board.subtitle': 'Las grandes decisiones se cuestionan, se contrastan y se hacen explícitas. Lleva la tuya ante 12 especialistas y sal con una dirección clara.',
    ...
    'overview.kicker': 'Más allá de una opinión',
    'overview.title': 'Una deliberación que puedes seguir.',
    'overview.stepOne': 'Debatir',
    'overview.stepOneDesc': 'Especialistas revisan tu decisión, una perspectiva cada vez.',
    'overview.stepTwo': 'Decidir',
    'overview.stepTwoDesc': 'El Chairman convierte el debate en un veredicto y próximos pasos.',
    'overview.stepThree': 'Rebatir y reconducir',
    'overview.stepThreeDesc': 'Cuestiona el veredicto, añade PDF, Markdown o imágenes y reconduce la decisión con el Chairman.',
